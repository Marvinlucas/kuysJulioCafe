...
<body>
    ...
    <div class="container search">
        <h2 class="py-2">Search Result for <em>"
        ...
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="food-item-wrap">
                        ...
                        <div class="content">
                            <h5><a href="viewMenuList.php?catid=' . $catId . '">' . $catname . '</a></h5>
                            <div class="product-name">' . substr($catdesc, 0, 30) . '... </div>
                            <div class="row justify-content-center">
                            <div class="price-btn-block"> <span class="price"></span> <a href="viewMenuList.php?catid=' . $catId . '" class="btn theme-btn-dash pull-right">View All</a> </div>
                            </div>
                            </div>
                    </div>
                </div>';
