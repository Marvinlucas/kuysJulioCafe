    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            ...
            <img src="assetsForSideBar/img/logo2.png" alt="">
                    ...
                    <span class="nav__logo-name">Kuyz JULIO CAFÉ</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=sizeManage" class="nav__link nav-sizeManage">
                    <i class='bx bxs-vial nav__icon'></i>
                      <span class="nav__name"> Sizes</span>
                    </a>
                    <a href="index.php?page=addonManage" class="nav__link nav-addonManage">
                    <i class='bx bx-cookie nav__icon' ></i>
                      <span class="nav__name"> AddOns</span>
                    </a>
