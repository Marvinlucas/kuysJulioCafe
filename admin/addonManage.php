<div class="container-fluid" style="margin-top:98px">
    <div class="row">
			...
			<form action="partials/_addonManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-body">
                            ...
                            <div class="form-group">
								...
								<input type="number" class="form-control" name="addonPrice" required min="0">
							</div>	
						...
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: #5b3934; color:#fff;">
								<tr>
                                    ...
                                    <th class="text-center" style="width:58%;">AddOns Detail</th>
									<th class="text-center" style="width:18%;">Action</th>
								</tr>
							</thead>
							<tbody>
                            <?php
    $sql = "SELECT a.*, c.categorieName 
            FROM `addon` a
            INNER JOIN `categories` c ON a.categoryId = c.categorieId";
    ...
    while($row = mysqli_fetch_assoc($result)){
        $menuId = $row['id'];
        $menuName = $row['addonName'];
        $menuPrice = $row['addonPrice'];
        ...
        echo '<tr>
                ...
                <td class="text-center">
                    <div class="row mx-auto" style="width:112px">
                        ...
                        <form action="partials/_addonManage.php" method="POST">
...
<?php 
    $menusql = "SELECT * FROM `addon`";
    $menuResult = mysqli_query($conn, $menusql);
    while($menuRow = mysqli_fetch_assoc($menuResult)){
        $menuId = $menuRow['id'];
        $menuName = $menuRow['addonName'];
        $menuPrice = $menuRow['addonPrice'];
      ...
      <div class="modal-body">
		...
		<form action="partials/_addonManage.php" method="post">
            <div class="text-left my-2">
                <b><label for="name">AddOns Name</label></b>
			...
			<div class="text-left my-2 row">
				<div class="form-group col-md-6">
                	...
                	<input class="form-control" id="price" name="price" value="<?php echo $menuPrice; ?>" type="number" min="0" required>
				</div>
				<div class="form-group col-md-6">
