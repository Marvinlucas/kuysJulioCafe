...
<div class="container-fluid" style="margin-top:98px">
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-cart float-right btn-sm" data-toggle="modal" data-target="#newUser"><i class="fa fa-plus"></i> New user</button>
        </div>
	</div>
	    <br>
	<div class="row">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/kuysjuliocafe/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/kuysjuliocafe/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-cart" data-toggle="modal" data-target="#editUser' .$Id. '" type="button">Edit</button>';
                                            if($Id == 1) {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              ...
              <button type="submit" name="createUser" class="btn btn-cart">Submit</button>
            </form>
      </div>
    </div>
  </div>
      ...
      <div class="modal-header" style="background-color: #e9ecef">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-cart mt-3" name="updateProfilePhoto">Update Img</button>
                    </form>         
                </div>
                <div class="form-group col-md-4">
                    <img src="/kuysjuliocafe/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/kuysjuliocafe/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-cart mt-2" name="removeProfilePhoto">Remove Img</button>
                    </form>
                </div>
            </div>
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                <button type="submit" name="editUser" class="btn btn-cart">Update</button>
            </form>
        </div>
    </div>
  </div>
