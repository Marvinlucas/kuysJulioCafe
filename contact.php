  ...
  <div class="container contact">
    <div class="row contact-container">
      <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-8">
              <div class="contact-box p-4">
                ...
                // Add a condition to check if $passRow is null
                if ($passRow != null) {
                  $email = $passRow['email'];
                  $phone = $passRow['phone'];
                } else {
                  // Set default values if $passRow is null
                  $email = "";
                  $phone = "";
                }
                ?>
                ...
                <form action="partials/_manageContactUs.php" method="POST">
                  <div class="row">
                    ...
                    <?php if ($loggedin) { ?>
                      <div class="col-lg-12">
                        <button type="submit" class="btn cart mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT NOW
                            <i class="ti-arrow-right"></i></span></button>
                        <button type="button" class="btn cart mt-3 mb-3 text-white border-0 py-2 px-3 mx-2"
                          data-toggle="modal" data-target="#history"><span> HISTORY <i
                              class="ti-arrow-right"></i></span></button>
                      </div>
                    <?php } else { ?>
                      <div class="col-lg-12">
                        <button type="submit" class="btn cart mt-3 text-white border-0 py-2 px-3" disabled><span> SUBMIT
        ...
        <div class="bg-image" style="background-image:url(img/contact.jpg); object-fit: cover; width: 100%; height: 100%;">
