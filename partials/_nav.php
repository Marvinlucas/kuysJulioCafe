...
echo '<nav class="navbar navbar-expand-lg navbar-dark bgcolor">
<a class="navbar-brand" href="index.php">
<img class="navbar-bran" src="img/logo1.png" alt="Logo" >
</a>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewMenuList.php?catid=' .$row['categorieId']. '">' .$row['categorieName']. '</a>';
            }
            echo '</div>
          </li>';
...
echo '<li class="nav-item">
        ...
        <form method="get" action="/kuysjuliocafe/search.php" class="form-inline my-2 my-lg-0">
        ...
        echo '<a href="viewCart.php" class="mx-2" title="My Cart">
