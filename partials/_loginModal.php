<!-- Login Modal -->
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModal" aria-hidden="true" style="z-index: 2;">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p class="mb-0 mt-1"><a href="#" data-dismiss="modal" data-toggle="modal" data-target="#forgotModal">Forgot Password</a>.</p>
          </div>
        </div>
      </div>
    </div>
