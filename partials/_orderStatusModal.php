...
while ($statusmodalrow = mysqli_fetch_assoc($statusmodalresult)) {
    ...
    elseif ($status == 5)
        ...
        $deliveryTime = ''; // Initialize with a default value
        $deliveryBoyName = ''; // Initialize with a default value
        $deliveryBoyPhoneNo = ''; // Initialize with a default value
        $trackId = ''; // Initialize with a default value
...
if ($status >= 1 && $status <= 4) {
    ...
    if (mysqli_num_rows($deliveryDetailResult) > 0) {
        ...
        // Set default values or handle the case where no delivery details are found
        $trackId = 'xxxxx';
        $deliveryBoyName = '';
        $deliveryBoyPhoneNo = '';
        $deliveryTime = 'xx';
