...
<body>
    ...
    if ($loggedin) {
        ...
        <div class="container profile">
            ...
            ?>
            <div class="row">
                <div class="jumbotron col-md-4 mb-3"
                    style="display: flex; justify-content: center; border-radius: 1.1rem; margin: 0 auto;">
                    <div class="user-info" style="max-width: 100%;">
                        <img class="rounded-circle mb-3 bg-dark" src="img/person-<?php echo $userId; ?>.jpg"
                            ...
                            style="width: 215px; height: 215px; object-fit: cover; padding: 1px;">
                        <form action="partials/_manageProfile.php" method="POST">
                            <small>Remove Image: </small><button type="submit" class="btn cart" name="removeProfilePic"
                        ...
                        <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data"
                            ...
                            <button type="submit" name="updateProfilePic" class="btn cart"
                        ...
                        <ul class="meta list list-unstyled" style="text-align:center;">
                            ...
                            <li class="name">
                                <?php echo $firstName . " " . $lastName; ?><label class="label label-info">(
                                    <?php echo $userType ?>)
                                </label>
                            </li>
                            <li class="email">
                            ...
                            <li class="my-2"><a href="partials/_logout.php"><button class="btn cart"
                ...
                <div class="content-panel col-md-8 mb-3" style="display: flex; justify-content: center;">
                    <div class="border p-3"
                        style="border: 2px solid rgba(0, 0, 0, 0.1); border-radius: 1.1rem; background-color: #e9ecef; width: 100%;">
                        ...
                        <form action="partials/_manageProfile.php" method="post">
                            ...
                            <button type="submit" name="updateProfileDetail"
